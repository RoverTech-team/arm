...
: ${AMENT_CURRENT_PREFIX:="/my_files/rovertest/install/rover_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_cpp/environment/path.sh"
