...
: ${AMENT_CURRENT_PREFIX:="/github/arm/setup/rovertest/install/rover_model"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_model/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_model/environment/path.sh"
